...
public class JDBCday2 {
    ...
    public void test3 () {
        ...
        String query = "INSERT INTO employees (first_name, last_name, email, " +
        ...
        //to creat in database


//        UPDATE employees SET email = 'gggoeersf@yahoo.com'
...
//                phone_number, hire_date, job_id, salary, commission_pct,
//                manager_id, department_id)
//        VALUES('fun', 'greem', 'bybymmail@gmail.com', '515.123.4567', '2018-06-17 00:00:00', 'IT_PROG', 10101.01, 0.01, 100, 110);
